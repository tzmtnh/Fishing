...
////// Emissive:
                ...
                float node_8430 = sin(((i.uv0.r*200.0)+(node_1819.g*20.0)));
                float3 emissive = (max(lerp(_Low.rgb,_Deep.rgb,i.uv0.g),step(i.uv0.g,(node_8430*0.0005+0.0025)))*step((node_8430*0.0005+0.0005),i.uv0.g));
