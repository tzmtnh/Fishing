...
Shader "Shader Forge/Water" {
    Properties {
        ...
        _GroundFrequency ("GroundFrequency", Float ) = 5
    }
    SubShader {
        Tags {
        ...
        Pass {
            ...
            uniform float _GroundFrequency;
            struct VertexInput {
...
////// Emissive:
                ...
                float3 emissive = (lerp(lerp(_Ground.rgb,lerp(_Low.rgb,_Deep.rgb,node_7035),step(node_7035,(sin((i.uv0.r*_GroundFrequency))*0.01000002+0.91))),_Foam.rgb,step(node_7035,(node_8430*0.0005+0.0025)))*step((node_8430*0.0005+0.0005),node_7035));
